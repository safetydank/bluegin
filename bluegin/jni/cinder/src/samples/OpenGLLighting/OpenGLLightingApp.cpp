...
class OpenGLLightingApp : public App {
  public:
...
void OpenGLLightingApp::update(float dt)
{
    static float elapsed = 0;
    elapsed += dt;

    mLightPos = Vec3f(50.0f * sin(elapsed*2), 50.0f * cos(elapsed*2), 75.0f);
